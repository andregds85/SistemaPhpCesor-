...
?>
 ...
 <div class="container-fluid">      
  ...
  <div class="container">
    ...
    <h1 class="display-4">Procedimento por Forma</h1>
    <p class="lead"> </p>
  </div>
  </div>
   </div> 
...
<div class="container-fluid">      
 ...
 <h1>
    <h1 class="display-4">Passo 1 - Limpe o Diretório. </h1>
     <p align="center">Limpe o diretório clicando aqui <a href="importforma/apagar.php">Limpar Diretório</a> 
       </p>
  </div>
</div>
</div>     
...
<form method="post" action="importforma/recebe_upload.php" enctype="multipart/form-data">
<label>Arquivo:</label>
...
<br>
 <p align="center">Antes de importar o CSV, limpe o diretório clicando aqui <a href="importforma/apagar.php">Limpar Diretório</a> </p>
 </div>
 </div>
 </div>    
 <div class="container-fluid">      
