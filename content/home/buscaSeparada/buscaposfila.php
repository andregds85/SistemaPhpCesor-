...
while ($produto = mysqli_fetch_array($produtos)) { 
        ...
        $produto['codCid'];
        $produto['desCid'];
        $codSigTap=$produto['codSigTap'];

     $Separadogrupo = substr($codSigTap, 0, 1); 
     $Separadosubgrupo = substr($codSigTap, 0, 3); 
     $Separadoforma = substr($codSigTap, 3, 6); 
    
    
        $vSeparadogrupo[] =$Separadogrupo;
